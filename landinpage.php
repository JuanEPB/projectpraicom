                        ...
                        <div class="accordion-body">
                            <div class="col-md-4">
                                <div class="card h-100" >
                                    <img src="./img/catalogoairpipe.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">Somos distribuidores de productos AirPipe</h5>
                                        <p class="card-text">
                                        </p>
                                        <button class="btn btn-primary open-pdf" data-pdf="./documents/catalogoairpipe.pdf">Ver Catálogo</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <div class="col-md-4">
                                <div class="card h-100" >
                                    <img src="./img/catalogobeko.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">Distribuimos productos de beko</h5>
                                        <p class="card-text">
                                        </p>
                                        <button class="btn btn-primary open-pdf" data-pdf="./documents/catalogobeko.pdf">Ver Catálogo</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-primary open-pdf" data-pdf="./documents/catalogosmc.pdf">Ver Catálogo</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-body">
                            <div class="col-md-4">
                                <div class="card h-100" >
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Detección, Análisis de Fugas con Equipo Ultrasonido</h5>
                                        <p class="card-text">
                                        </p>
                                        <a href="https://www.fotric.com/post/revolutionizing-gas-leak-detection-with-fotric-td3-ld-acoustic-camera" class="btn btn-primary">Ver Más</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- SMC para abrir el PDF en el modal -->
<script>
...
style="
    ...
    z-index: 500;
">
    ¿Deseas cotizar?, envíanos un mensaje directo!
</button>

<div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Contáctanos</h5>
    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body">
        <div class="formulario">
        <form id="form" method="post" action="formularioventa.php" class="form">
            <div class="mb-3">
            <label for="name" class="form-label">Nombre</label>
            <input name="name" required type="text" id="name" placeholder="Nombre" class="form-control">
            </div>
            <div class="mb-3">
            <label for="subject" class="form-label">Asunto</label>
            <input name="subject" required type="text" id="subject" placeholder="Asunto" class="form-control">
            </div>
            <div class="mb-3">
            <label for="email" class="form-label">Correo electrónico</label>
            <input name="email" type="email" id="email" required placeholder="example@gmail.com" class="form-control">
            </div>
            <div class="mb-3">
            <h6 for="message" class="form-label">Marca a cotizar</h6>
            <input type="radio" id="Airpipe" name="marca" value="Airpipe">
                <label for="Airpipe">Airpipe</label><br>
                <input type="radio" id="Beko" name="marca" value="Beko">
                <label for="Beko">Beko</label><br>
                <input type="radio" id="SMC" name="marca" value="SMC">
                <label for="SMC">SMC</label>
                <input type="radio" id="Fortric" name="marca" value="Fortric">
                <label for="Fortric">Fortric</label>
            </div>
    ...
    <ul class="footer-options">
        <li><a href="./index.php#Contactanos">Contactanos</a></li>
        <li><a href="./about.html">Informacion de contacto</a></li>
    </ul>
</footer>
