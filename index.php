            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="logo">
                    <picture>
                        ...
                        <img src="./img/logo.png" width="350px" alt="Logo de PRAICOM, empresa de aire comprimido">
                    </picture>                
                </div>
                <!-- Navegación -->
    ...
    <div class="formulario">
                <form id="form" method="post" action="formulario.php" class="form">
                    ...
                    <div>
                        ...
                        <input name="email" type="email" id="email" required placeholder="example@gmail.com">
                    </div>
                    <div>
